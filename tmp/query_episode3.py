...
def main():
    ...
    query = """
    Dựa trên các tài liệu trong notebook, hãy soạn 10 mục hội thoại và từ vựng về chủ đề tại nhà hàng (như gọi món, hỏi giá, thể hiện sở thích ngon/không ngon).
    Mỗi mục cần:
