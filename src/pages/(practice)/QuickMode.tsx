      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-pink-50/30 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-black text-foreground">Quick 5</h1>
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-3 border border-border/50 shadow-sm">
          ...
          <div className="space-y-3">
            ...
            <Button
              variant="ghost"
              onClick={() => navigate('/')}
              className="w-full text-muted-foreground/70 hover:text-sakura gap-2"
            >
  ...
  if (phase === 'done') {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-pink-50/30 flex items-center justify-center p-4">
        ...
        >
          {/* Score card */}
          <div className="bg-white rounded-[2.5rem] p-8 text-center shadow-xl border border-border/30 space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground/70 font-bold uppercase tracking-widest mt-1">Chính xác</p>
            </div>
          ...
          <div className="space-y-2">
            ...
            <Button variant="ghost" onClick={() => navigate('/')} className="w-full text-muted-foreground/70 gap-2">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-pink-50/20 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex items-center justify-between">
          <Button variant="ghost" size="sm" onClick={() => navigate('/')} className="text-muted-foreground/70 gap-1 hover:text-sakura">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            exit={{ opacity: 0, x: -30 }}
            className="bg-white rounded-[2.5rem] p-8 text-center shadow-xl border border-border/30 space-y-4"
          >
            <div className="flex items-center justify-center gap-2 mb-1">
              <BookOpen className="h-3 w-3 text-sakura/60" />
              <span className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/70">{q.promptLabel}</span>
            </div>

            <div className="space-y-1">
              <p className="text-5xl font-jp font-black text-foreground tracking-tight">{q.prompt}</p>
              {q.promptFurigana && (
        ...
        <div className="space-y-2">
          {q.options.map((opt, i) => {
            ...
            let bg = 'bg-white border-border/50 hover:border-sakura/30 hover:bg-sakura/5';
            let labelBg = 'bg-cream text-muted-foreground/70';
            ...
            if (answered) {
              ...
              else { bg = 'bg-white border-border/50 opacity-40'; }
            }
            ...
            return (
              ...
              >
                ...
                <span className="text-sm font-semibold text-foreground/80 flex-1 leading-snug">{opt}</span>
        ...
        <AnimatePresence>
          {answered && (
            ...
            >
              <button
                onClick={handleNext}
                className="w-full py-4 rounded-[2rem] bg-card text-white font-black flex items-center justify-center gap-2 hover:bg-primary/90 transition-all active:scale-95 shadow-xl"
              >
