...
import { DictationPlayer } from '@/components/media/DictationPlayer';
                ...
                >
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center justify-between mt-3">
                      ...
                      <div className="ml-4 h-8 w-8 rounded-full bg-cream flex items-center justify-center group-hover:bg-sakura/10 transition-colors">
                        {video.total_segments > 0 && video.total_segments === video.completed_segments ? (
                          <CheckCircle className="h-4 w-4 text-green-500" />
                        ) : (
                          <ChevronRight className="h-4 w-4 text-muted-foreground/50 group-hover:text-sakura transition-colors" />
                        )}
                      </div>
                    </div>
                  </CardContent>
