            ...
            <div className="grid gap-4">
              {searching ? (
                ...
                <EmptyState
                  ...
                  description={`Không có người dùng nào khớp với "${searchTerm}". Thử tên khác xem sao.`}
                />
              ) : null}
          ...
          <div className="grid gap-4">
            {loading ? (
              ...
              <EmptyState
                ...
                description="Tìm bạn cùng học để cùng nhau leo bảng xếp hạng và giữ streak!"
                actionLabel="Tìm bạn ngay"
                onAction={() => document.querySelector<HTMLInputElement>('input[placeholder*="Tìm"]')?.focus()}
              />
            ) : (
              friends.map((friend) => (
