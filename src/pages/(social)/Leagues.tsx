...
const LEAGUES = [
  ...
  { name: 'Bạc', color: 'bg-muted-foreground/50', icon: <Award className="h-6 w-6" />, active: true },
      ...
      <main className="container py-10 space-y-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <Card className="border-2 border-sakura/20 bg-white/40 backdrop-blur-md shadow-elevated overflow-hidden rounded-[2.5rem]">
          ...
          <aside className="space-y-6">
            ...
            <Card className="border-2 border-sakura/10 bg-white/40 backdrop-blur-md rounded-[2rem] overflow-hidden">
              <CardHeader className="pb-2">
