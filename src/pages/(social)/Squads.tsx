          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {loading ? (
              ...
              tab === 'mine' ? (
                <EmptyState
                  emoji="🛡️"
                  title="Bạn chưa vào squad nào"
                  description="Tham gia squad để cùng học, đua XP tuần và nhận thưởng nhóm."
                  actionLabel="Tạo squad mới"
                  onAction={() => setDialogOpen(true)}
                  secondaryActionLabel="Khám phá squad"
                  onSecondaryAction={() => setTab('all')}
                />
              ) : (
                <EmptyState
                  emoji="🔍"
                  title="Không tìm thấy squad"
                  description="Hãy thử từ khoá khác hoặc tạo squad đầu tiên cho riêng bạn."
                  actionLabel="Tạo squad"
                  onAction={() => setDialogOpen(true)}
                />
              )
            ) : (
