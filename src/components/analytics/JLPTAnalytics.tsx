    ...
    return (
      <Card className="border-sakura/20 bg-sakura-light/5 rounded-[2rem]">
        <CardContent className="p-12 text-center space-y-4">
          ...
          <h3 className="text-xl font-black text-foreground">Chưa có dữ liệu phân tích</h3>
          <p className="text-muted-foreground/70 text-sm max-w-xs mx-auto">Hãy hoàn thành ít nhất một đề thi Mock Exam để chúng tôi có thể thống kê tiến độ của bạn.</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="rounded-[2.5rem] border-sakura/10 shadow-soft overflow-hidden group">
          <CardContent className="p-8 space-y-4">
            ...
            <div>
              <p className="text-[10px] font-black text-muted-foreground/70 uppercase tracking-widest">Điểm trung bình</p>
              <h4 className="text-4xl font-black text-foreground">{avgScore}<span className="text-sm text-muted-foreground/50 ml-1">/180</span></h4>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-[2.5rem] border-sakura/10 shadow-soft overflow-hidden group">
          <CardContent className="p-8 space-y-4">
            ...
            <div>
              <p className="text-[10px] font-black text-muted-foreground/70 uppercase tracking-widest">Tiến độ cải thiện</p>
              <h4 className="text-4xl font-black text-foreground">
                ...
                <span className="text-sm text-muted-foreground/50 ml-1">so với lần đầu</span>
              </h4>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-[2.5rem] border-sakura/10 shadow-soft overflow-hidden group">
          <CardContent className="p-8 space-y-4">
            ...
            <div>
              <p className="text-[10px] font-black text-muted-foreground/70 uppercase tracking-widest">Trình độ mục tiêu</p>
              <h4 className="text-4xl font-black text-foreground">{latest.level}</h4>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="rounded-[2.5rem] border-sakura/10 shadow-soft overflow-hidden">
          <CardHeader>
            <CardTitle className="text-lg font-black text-foreground">Xu hướng điểm số</CardTitle>
        ...
        <Card className="rounded-[2.5rem] border-sakura/10 shadow-soft overflow-hidden">
          <CardHeader>
            <CardTitle className="text-lg font-black text-foreground">Phân tích kỹ năng</CardTitle>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="rounded-[2.5rem] border-sakura/10 shadow-soft overflow-hidden">
          <CardHeader>
            <CardTitle className="text-lg font-black text-foreground">Cân bằng kỹ năng</CardTitle>
        ...
        <Card className="rounded-[2.5rem] bg-gradient-to-br from-slate-900 to-slate-800 border-none shadow-xl overflow-hidden relative group">
           ...
           <CardContent className="p-8 space-y-6 relative z-10">
              ...
              <div className="flex items-end gap-4">
                 ...
                 <div className="pb-2 text-muted-foreground/70 font-bold text-sm uppercase tracking-widest">Sẵn sàng</div>
              </div>
              ...
              <Button className="w-full bg-white text-foreground hover:bg-sakura-light/20 font-black rounded-2xl h-12 shadow-lg">
