                  ...
                  <div key={index} className="bg-card border rounded-2xl overflow-hidden shadow-sm">
                    <Tabs defaultValue="info" className="w-full">
                      ...
                      <TabsContent value="info" className="mt-0">
                        <div className="flex flex-col sm:flex-row bg-cream/50 border-b">
                          <div className="w-full sm:w-1/2 min-h-[160px] relative flex items-center justify-center p-4 bg-white">
                            {aliveData?.kanji.video ? (
                              <div className="relative group cursor-pointer" onClick={() => toggleVideoPlayback(data.char)}>
                                ...
                                />
                                {!isPlaying[data.char] && (
                                  <div className="absolute inset-0 flex items-center justify-center bg-primary/10 rounded-lg transition-all group-hover:bg-primary/90/20">
                          ...
                          <div className="w-full sm:w-1/2 p-4 flex flex-col justify-center space-y-3">
                            ...
                            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                              {strokeCount && (
                                <Badge variant="secondary" className="bg-sakura-light/20 text-foreground/70 text-[10px]">
                                  {strokeCount} nét
                                </Badge>
                              )}
                              {apiData?.jlpt && (
                      ...
                      <TabsContent value="practice" className="mt-0 p-4 pt-6 bg-cream/30">
                        <KanjiStrokeWriter 
                          character={data.char} 
                          onComplete={() => {}}
                        />
                        <div className="mt-4 p-3 bg-blue-50/50 rounded-xl border border-blue-100/50 flex items-start gap-3">
                          ...
                          <p className="text-[11px] leading-relaxed text-blue-700 font-medium">
                            Xem hoạt họa thứ tự nét và nhấn <strong>Luyện viết</strong> để bắt đầu viết thử chữ Kanji này.
                          </p>
                        </div>
                      </TabsContent>
                    </Tabs>
