  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[700px] h-[85vh] sm:h-auto sm:max-h-[90vh] flex flex-col p-0 overflow-hidden border-none shadow-elevated rounded-3xl">
        ...
        <div className="p-6 flex-1 overflow-y-auto space-y-6 bg-cream/50">
          {/* Selectors */}
                    ...
                    {result.examples.map((ex, idx) => (
                      <div 
                        ...
                        className={cn(
                          ...
                          ex.isGrammar1 ? "bg-blue-50/50 border-blue-100" : "bg-primary/5 border-primary/20"
                        )}
                      >
                         <div className="inline-flex items-center justify-center rounded-md px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-white/50 border mb-1">
