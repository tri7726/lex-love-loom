...
const VocabularyItem: React.FC<{ vocab: VocabularyData }> = ({ vocab }) => {
  ...
  const handleAddFlashcard = () => {
    toast({
      ...
      description: `Từ "${vocab.word}" đã được thêm vào bộ thẻ của bạn.`,
    });
  };
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-1">
          <Button
            ...
            title="Phát âm"
            aria-label={`Phát âm từ ${vocab.word}`}
            disabled={isSpeaking}
          >
          ...
          {vocab.example_sentence && (
            <Button
              ...
              title={showDetails ? 'Ẩn ví dụ' : 'Xem ví dụ'}
              aria-label={showDetails ? 'Ẩn ví dụ' : 'Xem ví dụ'}
