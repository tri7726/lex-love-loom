  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full">
      <div className="relative w-full aspect-square max-w-[320px]">
        ...
        {/* Helper Grid */}
        <div className="absolute inset-0 pointer-events-none border-border/50 border-dashed border-2 m-6 rounded-2xl opacity-30">
      ...
      <div className="flex gap-2 w-full max-w-[320px]">
        <Button 
          variant="outline" 
          onClick={clearCanvas} 
          className="flex-1 gap-2 rounded-2xl h-12 border-2 hover:bg-cream transition-all font-bold"
        >
