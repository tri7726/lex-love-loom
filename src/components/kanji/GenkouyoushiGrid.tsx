...
const GhostCell: React.FC<{
  ...
  >
    ...
    >
      <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-px border-l border-dashed border-border" />
      <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-px border-t border-dashed border-border" />
    </div>
    {/* Ghost character */}
    <span
        ...
        <div className="flex items-center gap-3">
          <span
            className={cn(
              ...
              printMode ? 'text-4xl text-foreground' : 'text-4xl text-foreground'
            )}
          >
            {character}
          </span>
          <div className="flex flex-col gap-0.5">
            ...
            {meaning && (
              <span
                className={cn(
                  'text-[11px] italic',
                  printMode ? 'text-muted-foreground' : 'text-muted-foreground'
                )}
              >
                {meaning}
              </span>
            ...
            <motion.button
              ...
              className={cn(
                ...
                drawMode
                  ...
                  : 'bg-sakura-light/20 text-muted-foreground'
              )}
      ...
      <div
        className={cn(
          ...
          printMode
            ...
            : 'border rounded-xl overflow-hidden border-border shadow-sm'
        )}
