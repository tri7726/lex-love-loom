...
export const VoiceHub = ({ isOpen, onClose, onSuccess, targetSentence, systemPrompt }: VoiceHubProps) => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center p-4 bg-primary/50 backdrop-blur-sm"
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 min-h-0">
              ...
              >
                ...
                <div className={cn('flex-1 space-y-1.5 max-w-[82%]', msg.role === 'user' ? 'items-end flex flex-col' : '')}>
                  ...
                  <div className={cn(
                    ...
                    msg.role === 'sensei'
                      ? 'bg-white border border-sakura/10 rounded-tl-none shadow-sm'
          ...
          {isProcessing && (
            <div className="flex gap-2.5">
              ...
              <div className="px-4 py-3 rounded-2xl rounded-tl-none bg-white border border-sakura/10 shadow-sm">
