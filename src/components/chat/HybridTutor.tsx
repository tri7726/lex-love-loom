      ...
      <AnimatePresence>
        {(isPanelOpen || isLoading) && (
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-full lg:w-[500px] bg-white border-l-2 border-sakura/20 shadow-[0_0_50px_rgba(0,0,0,0.15)] z-[120] flex flex-col"
          >
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide p-6 bg-cream/50">
              {isLoading ? (
                ...
                <div className="space-y-8 pb-10">
                  ...
                  {result.overall_analysis && (
                    <Card className="border-2 border-sakura/10 shadow-soft bg-white/80 rounded-2xl overflow-hidden p-5 space-y-4">
                      ...
                      <p className="text-sm leading-relaxed font-bold text-foreground/80">
                  ...
                  {/* Mode Toggle */}
                  <div className="flex bg-white p-1.5 rounded-2xl border-2 border-sakura/10 shadow-sm w-full">
                    <Button 
                  ...
                  <div className="space-y-4">
                    ...
                    {result.isCorrect !== undefined ? (
                      <div className="p-6 bg-white rounded-3xl border-2 border-sakura/20 shadow-lg space-y-4">
                        <div className="flex items-center gap-3">
                        ...
                        {result.explanation && (
                          <div className="bg-cream p-4 rounded-xl border border-border/50">
                      ...
                      <div className="space-y-6">
                        {result.sentences?.map((sentence, sIdx) => (
                          <motion.div key={sIdx}
                            ...
                            className="p-5 bg-white rounded-3xl border border-sakura/10 hover:border-sakura/30 shadow-sm transition-all space-y-4"
                          >
                              ...
                              <div className="pt-4 border-t border-sakura/5 space-y-3">
                                ...
                                {sentence.breakdown.grammar_patterns.map((gp, gpIdx) => (
                                  <div key={gpIdx} className="bg-sakura/5 rounded-xl p-3 border border-sakura/10">
                                    ...
                                    <p className="text-xs font-bold text-foreground/80">{gp.meaning}</p>
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {sentence.breakdown.words.map((w, wIdx) => (
                                    <div key={wIdx} className="group/word relative">
                                      ...
                                      {selectedMode === 'vocab' && (
                                        <div className="hidden group-hover/word:block absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 bg-white border border-sakura/20 rounded-xl shadow-xl p-3 z-50">
                          ...
                          <Card className="border-2 border-sakura/5 bg-sakura/5 rounded-3xl overflow-hidden p-6 space-y-4">
                            ...
                            <ul className="space-y-3">
                              {result.cultural_notes.map((note, nIdx) => (
                                <li key={nIdx} className="text-xs font-bold text-foreground/70 leading-relaxed list-disc ml-4">
                                  {note}
                                </li>
                              ))}
                            </ul>
                      ...
                      result.sentences && result.sentences.length > 0 ? (
                        <AnimatePresence mode="wait">
                          <motion.div
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            exit={{ opacity: 0, x: -50 }}
                            className="p-8 bg-white rounded-[2.5rem] border border-sakura/20 shadow-2xl min-h-[450px] flex flex-col justify-center gap-8 relative overflow-hidden"
                          >
