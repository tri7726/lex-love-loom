...
export const SenseiInput: React.FC<SenseiInputProps> = ({ 
  ...
  return (
    <div className="p-2 md:p-3 bg-transparent space-y-4">
          ...
          <>
              ...
              <div className="absolute left-6 bottom-24 z-10 animate-in fade-in slide-in-from-bottom-2">
                <div className="relative group/img h-20 w-20 rounded-2xl overflow-hidden border-2 border-sakura shadow-lg">
                  ...
                  <button 
                    ...
                    className="absolute top-1 right-1 bg-primary/60 text-white rounded-full p-1 opacity-0 group-hover/img:opacity-100 transition-opacity"
                  >
            ...
            <div className="absolute left-6 bottom-4 flex items-center gap-2 z-10">
              <Button 
                ...
                className="h-12 w-12 rounded-2xl text-muted-foreground/50 hover:text-sakura hover:bg-sakura/5 transition-all"
              ...
              <Button 
                ...
                className={cn(
                  ...
                  isListening 
                    ...
                    : "text-muted-foreground/50 hover:text-sakura hover:bg-sakura/5"
                )}
            ...
            <Textarea
              ...
              className={cn(
                "min-h-[100px] max-h-[250px] w-full pl-36 pr-16 py-6 rounded-[2.5rem] border-0 bg-white shadow-[0_15px_40px_-10px_rgba(0,0,0,0.03)] focus-visible:ring-sakura/5 resize-none font-serif text-lg transition-all placeholder:italic placeholder:text-muted-foreground/40",
            ...
            <div className="absolute right-4 bottom-4 z-10">
              <Button
                ...
                className={cn(
                   ...
                   "bg-card hover:bg-primary/90 shadow-slate-200"
                )}
              >
      ...
      {!isLimited && (
        <p className="text-center text-[9px] text-muted-foreground/40 font-black uppercase tracking-[0.5em] pb-2">
