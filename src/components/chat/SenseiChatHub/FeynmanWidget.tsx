    ...
    >
      ...
      >
        ...
        <div className="flex-1 text-left">
          ...
          <p className="text-[10px] text-muted-foreground leading-tight">Giải thích <strong>{topic}</strong> bằng lời của bạn</p>
        </div>
          ...
          >
            <div className="px-4 py-3 space-y-3">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                💡 Hãy giải thích <strong className="text-foreground/80">{topic}</strong> như thể bạn đang dạy cho một người bạn chưa biết gì về tiếng Nhật.
              </p>
              ...
              {!result && (
                <>
                  <textarea
                    ...
                    rows={4}
                    className="w-full text-sm text-foreground/80 bg-white/80 border border-indigo-200/60 rounded-xl px-3 py-2.5 focus:outline-none focus:border-indigo-400 resize-none leading-relaxed placeholder:text-muted-foreground/50"
                  />
                  <button
