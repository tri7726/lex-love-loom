    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-12 text-center space-y-8 bg-transparent relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-4xl md:text-5xl font-medium text-foreground mb-4 font-serif max-w-3xl leading-tight tracking-tight">
            {cfg.title}
          </h2>
          <p className="text-xs md:text-sm text-muted-foreground/70 uppercase tracking-[0.4em] font-medium max-w-lg leading-loose opacity-70 mb-4">
            {cfg.subtitle}
          </p>
