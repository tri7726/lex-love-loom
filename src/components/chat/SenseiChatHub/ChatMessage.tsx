        ...
        {revealed && example && (
          ...
          >
            <div className="mx-3.5 mb-2.5 px-3 py-2 rounded-xl flex items-start gap-2"
              ...
              <p className="text-xs font-jp text-foreground/70 leading-relaxed italic flex-1">"{example}"</p>
  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-3 space-y-2.5">
        {/* Question */}
        <p className="text-sm font-bold text-foreground leading-snug">{data.question}</p>
  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-3 space-y-3">
        {/* Sentence */}
        <div className="text-base font-jp font-bold text-foreground leading-loose flex flex-wrap items-center gap-1">
        ...
        if (data.type === 'quiz') {
          ...
          widgets.push(
            ...
            >
              ...
              <p className="text-sm text-foreground/80 italic font-medium leading-relaxed">"{data.fact}"</p>
              {data.related_vocab && (
    ...
    return (
      <div className="flex flex-col w-full">
        <div className={cn(
          ...
          isAssistant
            ? "bg-white/80 backdrop-blur-xl border border-sakura/10 text-foreground rounded-tl-none self-start"
            : "bg-card text-white rounded-tr-none self-end ml-auto"
        )}>
          {isAssistant && (
