...
const WriteGame: React.FC<WriteGameProps> = ({
  ...
  const normalizeText = (text: string): string => {
    // Normalize for comparison: remove spaces, convert to lowercase for hiragana
      ...
      <Card className="text-center">
        <CardContent className="py-8">
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground mb-2">Viết từ tiếng Nhật cho:</p>
            <p className="text-2xl font-semibold">{currentQuestion.meaning}</p>
            ...
            {!isCorrect && (
              <Card className="bg-muted/50">
                <CardContent className="py-4 text-center">
                  ...
                  <p className="text-2xl font-jp">{currentQuestion.word}</p>
