                ...
                >
                  <div className={cn(
                    ...
                    <p className={cn(
                      ...
                      !showResult ? "text-foreground" : (showCorrect ? "text-[#166534]" : "text-red-700")
                    )}>
                      {option.word}
                    </p>
        ...
        {showResult && (
          <div className="flex items-center gap-3">
            <AISenseiExplain 
              ...
              trigger={
                <button className="flex items-center gap-2 bg-orange-100 text-orange-600 px-8 py-5 rounded-2xl font-black text-lg shadow-xl hover:bg-orange-200 transition-all active:scale-95">
            ...
            <motion.button 
              ...
              onClick={handleNext} 
              className="flex items-center gap-3 bg-card text-white px-12 py-5 rounded-2xl font-bold shadow-2xl hover:bg-primary/90 transition-all active:scale-95 group"
            >
