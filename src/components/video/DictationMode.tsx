...
import { KanaKeyboard } from '@/components/input/KanaKeyboard';
import { KanjiSuggestions } from '@/components/search/KanjiSuggestions';
...
interface DictationModeProps {
  ...
  grammarNotes?: Array<{ point: string; explanation: string }>;
...
export const DictationMode: React.FC<DictationModeProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Grammar chips */}
      {(grammarNotes.length > 0 || matchedGrammarPoints.length > 0) && (
