  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-[100] flex items-center justify-center bg-primary/60 backdrop-blur-sm p-4"
      >
        <motion.div
        ...
        >
          ...
          <div className="p-8 pb-10 text-center flex flex-col items-center">
            ...
            <h2 className="text-3xl font-black text-foreground mb-2 font-display">
              Lên Cấp!
            </h2>
