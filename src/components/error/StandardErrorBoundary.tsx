        ...
        <div className="min-h-screen bg-cream flex items-center justify-center p-6">
          <div className="max-w-md w-full bg-white rounded-[2.5rem] shadow-elevated border-2 border-sakura/20 p-10 text-center space-y-6 animate-in fade-in zoom-in duration-500">
            ...
            <div className="space-y-2">
              <h1 className="text-2xl font-black text-foreground font-display">Oops! Có lỗi xảy ra 🌸</h1>
            ...
            {this.state.error && (
              <div className="p-4 bg-cream rounded-2xl border border-border/50 text-left overflow-auto max-h-32 mb-4">
            ...
            <p className="text-[10px] text-muted-foreground/50 uppercase tracking-widest font-black pt-4">
