-- ═══════════════════════════════════════════════════════════════
-- DOMAIN: CLASSROOM & LESSONS — Classrooms, Members, Assignments, Progress
-- Gộp từ: 20260508_classroom_system, 20260508_lesson_system
-- ═══════════════════════════════════════════════════════════════
...
-- ── 5. TIẾN ĐỘ NHIỆM VỤ CỦA HỌC SINH ──────────────────────────
...
-- ── 12. SKILL ANALYTICS LOGIC (UPGRADED) ──────────────────────
...
-- RPC cho giáo viên xem báo cáo chi tiết
...
-- -- 11. C?P NH?T LO?I B�I T?P ----------------------------------
-- Th�m c?t tham chi?u b�i d?c v� ng? ph�p cho assignments
